...
async def building_landing_page(
    ...
    image_url: str,  # this will be your base64 data URL string
    theme: str = "minimal",
    ...
    Args:
        ...
        image_url: str - image to embed as base64 data URL
    ...
    Returns:
        HTML string or path of saved file depending on `return_as_string`
    """
    ...
    try:
        ...
        raise ValueError(
            f"Theme '{theme}' not found. Make sure '{theme}.html.j2' exists in '{TEMPLATE_DIR}'."
        )
    ...
    html = template.render(
        ...
        call_to_action=getattr(content, "call_to_action", ""),  # safe default empty string
        image_url=image_url,
